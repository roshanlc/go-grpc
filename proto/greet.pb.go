...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x22, 0x0a, 0x0c, 0x48, 0x65,
...
var file_proto_greet_proto_goTypes = []interface{}{
	...
	(*HelloRequest)(nil),  // 3: greet_service.HelloRequest
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	2, // 1: greet_service.GreetService.SayHelloServerStreaming:input_type -> greet_service.NameList
	3, // 2: greet_service.GreetService.SayHelloClientStreaming:input_type -> greet_service.HelloRequest
	3, // 3: greet_service.GreetService.SayHelloBidirectionalStreaming:input_type -> greet_service.HelloRequest
